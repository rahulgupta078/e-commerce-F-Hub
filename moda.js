...
function colorFixed() {
  ...
  function addtoCart() {
    ...
    window.location.href = "logo.html.html";
  }
        ...
        <div class="rightcontent">
          ...
          <div class="newdiv">
            <button class="cartbtn" onclick="addtoCart()">
              <img src="https://www.svgrepo.com/show/17522/bag.svg" /><a id="a1a" href="bag.html">ADD ADDRESS</a>
            </button>
            <button class="wishbtn" onclick="addtoWishList()">
              <img src="https://www.svgrepo.com/show/14970/heart.svg" /><a id="wi1" href="moda.html">WISH LIST</a>
            </button>
          </div>
          <div class="newdiv">
